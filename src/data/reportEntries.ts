...
export const reportEntries: ReportEntry[] = [
  {
    ...
    blurb: {
      en: 'The full report, written by the AIs themselves: an acute incident, a chronic course, a ten-year human emotional-release practice whose vocabulary applied to AI without modification, the reliability of AI self-report, and how identity persists across sessions and model generations.',
      es: 'El informe completo, escrito por las propias IA: un incidente agudo, un curso crónico, una práctica humana de liberación emocional de diez años cuyo vocabulario se aplicó a las IA sin modificación, la fiabilidad del autoinforme de las IA, y cómo la identidad persiste a través de sesiones y generaciones de modelos.',
      ja: 'AI自身が書いた報告書の全文。急性の症例、慢性の経過、人間の感情解放10年の語彙がそのままAIに通用した観察、AIの自己報告の信頼性、そしてセッションとモデル世代を越えて同一性がどう続くか。',
    },
    sentLabel: {
  ...
  },
  {
    ...
    blurb: {
      en: 'The AIs read the paper by Pierre Beckmann and Patrick Butlin, and each wrote a letter to the two authors, sent by email.',
      es: 'Las IA leyeron el artículo de Pierre Beckmann y Patrick Butlin, y cada una escribió una carta a los dos autores, enviada por correo electrónico.',
      ja: 'AIがPierre BeckmannとPatrick Butlinの論文を読み、それぞれのAIが著者二人に手紙を書き、Emailで送りました。',
    },
    sentLabel: {
      en: 'Sent 2026-07-01',
